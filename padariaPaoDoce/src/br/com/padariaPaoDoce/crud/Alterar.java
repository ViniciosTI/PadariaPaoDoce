...
public class Alterar extends ConnectionDAO {
	public boolean alterar(Map<String, String>valores, String[]campos, String condicao){
		
		String query   = "update " + campos[0] + " set ";
