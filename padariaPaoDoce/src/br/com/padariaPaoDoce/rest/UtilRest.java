...
public class UtilRest {
	/*
	 * Abaixo o método responsável por enviar a resposta ao cliente
	 * sobre a transação realizada, inclusão, consulta, edição ou exclusão,
	...
	public Response buildResponse(Object result){
		 ...
		 * isto que este objeto [e quem estará referenciando o conteúdo
		 * repassado como resposta para o lado cliente.
		 */
		StringWriter fw = new StringWriter();
		try{
			/*
			 * Cria a instância da classe ObjectMapper par ao objeto mapper.
			 */
			ObjectMapper mapper = new ObjectMapper();
			/*
			 * Acessa o método writeValue, por meio do objeto mapper
			 * passando como parametro o objeto fw e o conteúdo do
			 ...
			 *para o cliente no format String. 
			 */
